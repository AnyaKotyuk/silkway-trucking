 ...
 class FrontSpr extends SysSpr {
     ...
     public $db = NULL;
       ...
       function ShowInComboBox( $Table, $name_fld, $val, $width=40, $default_val = '&nbsp;', $sort_name = 'move', $asc_desc = 'asc', $params=NULL )
       {
          ...
          $fields_col = mysql_num_fields($this->db->result);
       ...
       function ShowInRadioBox( $Table, $name_fld, $cols, $val, $position = "left", $disabled = NULL, $sort_name = 'move', $asc_desc = 'asc' )
       {
        ...
        // Change Request Nbr:
        // ================================================================================================
        function ShowImage($spr = NULL, $lang_id = NULL, $img = NULL, $size = NULL, $quality = NULL, $wtm = NULL, $parameters = NULL, $ret_img_or_path=null)
        {

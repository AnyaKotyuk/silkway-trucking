   ...
   function ShowCommentsFormHTML()
   {
     ...
     <div id="commentsFormDtl">
       ...
       <table border="0" cellpadding="2" cellspacing="2" style="font-size: 12px;">
        ...
        ?>
        <tr>
         <td><?=$this->multi['FLD_LOGIN'];?>:&nbsp;<span class="input-requirement">*</span></td>
         <td><?$this->Form->TextBox( 'login',$this->login, 'size="40"' );?></td>
        </tr>
        <tr>
         <td><?=$this->multi['FLD_PASSWORD'];?>:&nbsp;<span class="input-requirement">*</span></td>
        ...
        ?>
        <tr>
         <td><?=$this->multi['TXT_FRONT_USER_NAME'];?>:&nbsp;<span class="input-requirement">*</span></td>
         <td align="left">
          <?$this->Form->TextBox( 'name', $this->name, 'size="40"' );?>
         </td>
        </tr>
        <tr>
         <td><?=$this->multi['TXT_FRONT_USER_EMAIL'];?>:&nbsp;<span class="input-requirement">*</span></td>
         <td><?$this->Form->TextBox( 'email',$this->email, 'size="40"' );?></td>
        </tr>
        <?}?>
        <tr>
         <td colspan="2">
          <?=$this->multi['TXT_FRONT_USER_COMMENT'];?>:&nbsp;<span class="input-requirement">*</span><br/>
        ...
        */?>
        <tr>
         <td colspan="2" align="left"><span class="input-requirement">*</span>
        ...
        <tr>
         ...
         <?
         $params = 'onclick="AddComment('."'/add_comments.php'".', '."'div_'".'); return false;"';
         $this->Form->Button( 'save_response', $this->multi['TXT_FRONT_ADD_COMMENT'], 50, $params );
        ...
        if($this->uselogon==1){
            ...
            if( !$this->Logon->user_id){
                ...
                if( !empty($this->login) ANd !empty($this->password) ){
                    ...
                    $tmp_status = $User->GetUserStatusByLogin($this->login);
                    //echo '$tmp_status='.$tmp_status;
                    if($tmp_status==2) {
                        $this->Err = $this->Err.$this->multi['MSG_FRONT_ERR_COMMENTS_ACCOUNT_NOT_ACTIVATED'].'<br/>';
                        return $this->Err;
                    }
                    if($tmp_status==1) {
                        $this->Err = $this->Err.$this->multi['MSG_FRONT_ERR_COMMENTS_ACCOUNT_BLOCKED'].'<br/>';
                        return $this->Err;
                    }
                    if($tmp_status==3) {

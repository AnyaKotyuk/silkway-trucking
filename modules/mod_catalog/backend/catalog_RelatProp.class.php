...
class catalog_RelatProp extends Catalog{
     ...
     * @author Bogdan Iglinsky
     */
    function showSameBlockForProp($relatPropArr, $name_Panel = '' , $nameText = ''){
        ...
        <?$hrefForScript = $this->script."&task=CatalogShow".$name_Panel."&ajax=1&propStr".$name_Panel."=".$propStr;?>
        <a class="various fancybox.ajax" href="<?=$hrefForScript;?>">
        ...
        <script type="text/javascript">
            ...
            function showCatalog<?=$name_Panel?>(){
                ...
                $propStrVal = $("#propStr<?=$name_Panel?>").val();
//                $href = //=$this->script."&task=CatalogShow".$name_Panel."&ajax=1&propStr".$name_Panel."="?>//'+$propStrVal;
            }
...
//        echo '<br>$q='.$q.' $res='.$res;
    ...
    function delete(){
        ...
        //delete items from goods where this item is connected
        $this->deleteonThisPropPanel();
    }

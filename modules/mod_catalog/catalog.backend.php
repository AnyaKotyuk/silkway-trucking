...
if (!isset($_REQUEST['cod_pli']))
    $cod_pli = $id;
else
    $cod_pli = $_REQUEST['cod_pli'];
    ...
    case 'save':
       ...
       // echo '<br> $Catalog->img_cat='.$Catalog->img_cat;
        ...
        if ( $Catalog->save() ){
            ...
            $Catalog->Err = $pg->Msg->show_text('MSG_ERR_NOT_SAVE');;
            $Catalog->ShowErrBackEnd();
        }
        break;
    case 'delete':

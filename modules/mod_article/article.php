...
else $cat = $Article->Form->GetRequestTxtData($_REQUEST['cat'], 1);
...
$Page->SetDescription( $Article->description );
$Page->SetKeywords( $Article->keywords );
$Page->SetMultiUrls($Article->getMultiUrls());

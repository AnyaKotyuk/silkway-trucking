          ...
          <td>
            ...
            */
            ...
            <tr>
                ...
                <?if (defined("MOD_DEPARTMENT") AND MOD_DEPARTMENT){?>
                    <tr>
...
//          echo '<br>q='.$q.' res='.$res.' $this->Right->result='.$this->Right->result;
    ...
    function SavePicture()
    {
     ...
     $max_image_height = ARTICLE_MAX_IMAGE_HEIGHT;
     $max_image_size = ARTICLE_MAX_IMAGE_SIZE;
     $max_image_quantity = ARTICLE_MAX_IMAGES_QUANTITY;
     $valid_types =  array("gif", "GIF", "jpg", "JPG", "png", "PNG", "jpeg", "JPEG");
...
//     echo $rows;
     ...
     ?>
      ...
      <TR>
       <TD colspan=2>
       <br /><br />
        <input type="hidden" name="MAX_FILE_SIZE" value="<?=ARTICLE_MAX_IMAGE_SIZE;?>">

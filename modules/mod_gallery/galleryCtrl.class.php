...
class GalleryCtrl extends Gallery{
    ...
    */
    ...
    ?>
     <TR><TD width="150"><?=$this->multi['_FLD_ID'];?>:&nbsp;
    <?
       if( $this->id!=NULL )
       {
        echo $mas['id'];
    ...
    if( $this->id!=NULL )
     ...
     while( $el = each( $this->ln_arr ) )
     {
        ...
        echo "</fieldset><br>";
         ...
         $this->Form->SpecialTextArea( $this->Form->textarea_editor, 'short['.$lang_id.']', stripslashes($val), 60, 80, 'class="contentInput"', $lang_id, 'full' );
         echo "\n <br>";

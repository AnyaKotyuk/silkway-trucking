...
// ================================================================================================
 ...
 static function PanelMainH( $img = NULL, $text = NULL )
 {
     /*
    ?>
...
// Change Request Nbr:
// ================================================================================================
    static function PanelSubH( $text, $property=NULL )
    {
        ?>
        <div class="box-header with-border"><h3 class="box-title"><?=$text?></h3></div>
        <div class="box-body">
    <?
    }
...
// ================================================================================================
 ...
 static function TablePartH()
 {
?><table border="0" width="100%" cellspacing="0" cellpadding="0" class="table table-striped "><?
 }

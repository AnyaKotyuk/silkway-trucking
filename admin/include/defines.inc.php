...
//if (!defined("ADMIN_LAYOUT")) define( "ADMIN_LAYOUT", "classic" );
if (!defined("ADMIN_LAYOUT")) define( "ADMIN_LAYOUT", "skin-blue" );


include_once( SITE_PATH."/include/Conf.inc.php");
include_once( SITE_PATH."/sys/define.php");

if(ADMIN_LAYOUT=='classic') {
    ...
    include_once(SITE_PATH . '/admin/include/adminLTE/classes/PageAdminLTE.class.php');
    include_once(SITE_PATH . '/admin/include/adminLTE/classes/PagePanel.class.php');
    include_once(SITE_PATH . '/admin/include/adminLTE/classes/PagePanelLTE.class.php');
    include_once(SITE_PATH . '/admin/include/adminLTE/classes/sysAuthorization.class.php');
    include_once(SITE_PATH . '/admin/include/adminLTE/classes/AdminHTML.class.php');
    include_once(SITE_PATH . '/admin/include/adminLTE/classes/table.class.php');
    include_once(SITE_PATH . '/admin/include/adminLTE/classes/backendForm.class.php');
    include_once(SITE_PATH . '/admin/include/adminLTE/classes/backendLang.class.php');
}
...
define("TblBackMulti","sys_txt_backend"); //old sys_back_txt
define("TblFrontMulti","sys_txt_frontend"); //old sys_front_txt

define("TblSysSession","sys_session");
define("TblSysSessionHash","sys_session_hash");
define("TblSysLang","sys_lang_spr"); //old sys_spr_lang
...
define("TblSysSettings","sys_user_set"); //old sys_set
define("TblSysSetGlobal","sys_set_global");
define("TblSysSetGlobalSprMail","sys_set_global_spr_mail");

//--- Users
define("TblSysGroupUsers","sys_user_group"); //old sys_group_user
define("TblSysUser","sys_user");
define("TblSysUserStat","sys_user_stat");

//--- Sys Func
define("TblSysFunc","sys_access_func"); //old sys_func
define("TblSysSprFunc","sys_access_func_spr"); //old sys_spr_func

//--- Admin Menu
define("TblSysMenuAdm","sys_access_menu_adm"); //old sys_menu_adm
define("TblSysSprMenuAdm","sys_access_menu_adm_spr"); //old sys_spr_menu_adm

//--- Access
define("TblSysAccess","sys_access_user_group"); //old sys_group_func
...
define("SPR_MAX_IMAGE_WIDTH","2500");
define("SPR_MAX_IMAGE_HEIGHT","2500");
define("SPR_MAX_IMAGE_SIZE",8182 * 1024);
define("SPR_WATERMARK_TEXT","");
define("SPR_ADDITIONAL_FILES_TEXT","_cmszoom_");

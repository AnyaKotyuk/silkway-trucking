...
if( !isset( $_REQUEST['front'] ) ) $m->front = 0;
else $m->front = 1;

if( !isset( $_REQUEST['back'] ) ) $m->back = 0;
else $m->back = 1;

if( !isset( $_REQUEST['back_lang_menu'] ) ) $m->back_lang_menu = 0;
else $m->back_lang_menu = 1;

if( !isset( $_REQUEST['def_front'] ) ) $m->def_front = 0;
else $m->def_front = 1;

if( !isset( $_REQUEST['def_back'] ) ) $m->def_back = 0;
else $m->def_back = 1;

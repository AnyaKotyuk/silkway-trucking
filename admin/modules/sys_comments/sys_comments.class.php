    ...
    function show() {
        ...
        //if($this->fltr2){
            ...
            if(defined("MOD_NEWS") AND MOD_NEWS){
                $lef_join .= "LEFT JOIN `".TblModNewsNames."` ON (`".TblSysModComments."`.`id_item`=`".TblModNewsNames."`.`id_news` AND `".TblModNewsNames."`.`lang_id`='".$this->lang_id."') ";
                $where .= " OR `".TblModNewsNames."`.`name` LIKE '%".$this->fltr2."%'";
            }

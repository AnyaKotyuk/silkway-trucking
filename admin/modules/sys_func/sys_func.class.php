     ...
     ?>
      ...
      <TD> <?
    		...
    		<TR><TD><b><?=$this->Msg_text['_FLD_PATH']?></b>
    			<TD>/ <?$this->Form->Select( PageAdmin::$type_action, 'target', $mas['target'], 70 );?> / <?$this->Form->TextBox( 'name', $val, 100 )?>
    		<tr>
                    <td>
                        <b>Для справочников<br> возможны установки: </b>
                    </td>
                    <td>
                        <ul>
                        <?=$this->Spr->showInFunc();?>
                            <li>usemove - возможность сортировки по-порядку</li>
                            <li>uselevels - многоуровневость</li>
                            <li>usemeta - мета данные</li>
                            <li>usetranslit - транслитерация для построения УРЛ</li>
                            <li>useuploadimages - возможность прикрепить много изображений без привязки к языковым версиям</li>
                            <li>useuploadfiles - возможность прикрепить много файлов без привязки к языковым версиям</li>
                        </ul>
                    </td>
    		<?

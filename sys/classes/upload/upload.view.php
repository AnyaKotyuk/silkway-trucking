    ...
    static function Uploadform($lang, $items, $text,$max,$count,$type,$formId=1){
        ...
        if($items>=0){
            ...
            <table cellpadding="1" cellspacing="1" border="0" class="mainUpload" id="ItemToUpload<?=$type?>"><?
                    ...
                    ?><tr><td>
                        <table cellpadding="3" cellspacing="1" border="0" class="itemUpload">
                            <tr>
                                ...
                                <td class="heads"><?=$text['TXT_TITLE'];?></td>
                                <?
                                for($j=0;$j<$lang_count;$j++){
                                    ?>
                ...
                ?></table>
            <div class="addButfon" id="addBut<?=$type?>">
                <div class="addBut"><input type="button" value="<?=$text['ADD']?>" onclick="add_el<?=$type?>()"></div>
                <div class="addBut"><input type="button" value="<?=$text['ADD_5']?>" onclick="add_el<?=$type?>cnt(5)"></div>
                <div class="addBut"><input type="button" value="<?=$text['ADD_10']?>" onclick="add_el<?=$type?>cnt(10)"></div>
            </div>
...
//             alert(max);
                ...
                function add_el<?=$type?>cnt(cnt){
                    for(i<?=$type?>=0;i<?=$type?><cnt;i<?=$type?>++){
                        add_el<?=$type?>();
                    }
                }
            </script>
               ...
               <table cellpadding="3" cellspacing="1" border="0" class="itemUpload" width="100%">
                <tr class="nodrag">
                    <td rowspan="2" class="path">
                        ...
                        <input type="hidden" name="moveF<?=$formId?>[]" value="<?=$items_keys[$i]?>"><br />
                        <div class="filepath">
            ...
            ?><tr id="v<?=$i?>"><td>
               <table cellpadding="3" cellspacing="1" border="0" class="itemUpload" width="100%">
                <tr class="nodrag">
                    <td rowspan="2" class="path">
                        <a href="<?=$file?>"><?=$items[$items_keys[$i]]['path']?></a>
                        <input type="hidden" name="moveV[]" value="<?=$items_keys[$i]?>"><br />
                        <div class="filepath">
                            <?=$text['_FLD_PATH'].': '."http://".NAME_SERVER.$file?>
                        </div>
                    </td>
    ...
    static function UploadedImages($lang, $items, $text, $path, $id_pos, $table, $table1,$formId=1){
        ...
        for($i=0;$i<$items_count;$i++){
            ...
            ?><tr id="I<?=$i?><?=$formId?>"><td>
               <table cellpadding="3" cellspacing="1" border="0" class="itemUpload" width="100%">
                <tr class="nodrag">
                    <td rowspan="2" class="path item-image">
                        <img src="<?=$file?>" />
                        <a href="#" onclick="delete_images<?=$formId?>( '<?=$table?>' ,'<?=$table1?>' ,'<?=$items_keys[$i]?>' ,'/<?=$path?>/<?=$id_pos?>','<?=$items[$items_keys[$i]]['path_original']?>','<?=$i?>');return false;"><img class="remove-img" src="/admin/images/cancel.png" alt="<?=$text['TXT_DELETE']?>" title="<?=$text['TXT_DELETE']?>" /></a>
                        <div>
                            <input type="checkbox" value="1" name="visibleI<?=$formId?>[<?=$items_keys[$i]?>]"<?if($items[$items_keys[$i]]['visible']==1) echo ' checked="checked"';?> id="show-item-image<?=$items_keys[$i]?>" /><label for="show-item-image<?=$items_keys[$i]?>">&nbsp;<?=$text['TXT_VISIBLE']?></lable>
                        </div>
                    ...
                    for($j=0;$j<$lang_count;$j++){
                        ?>
                        <td class="lang">
                            <?php $Form->TextBox( 'titleI'.$formId.'s['.$items_keys[$i].']['.$lang_keys[$j].']', stripslashes($items[$items_keys[$i]]['name'][$lang_keys[$j]]), 110 );?>
<!--                            <input name="titleI--><?//=$formId?><!--s[--><?//=$items_keys[$i]?><!--][--><?//=$lang_keys[$j]?><!--]" size="20" value="--><?//=$items[$items_keys[$i]]['name'][$lang_keys[$j]]?><!--" />-->
                        </td>
                        <?
                    }
                    ?>
                ...
                <tr class="nodrag">
                    ...
                    for($j=0;$j<$lang_count;$j++){
                        ?>
                        <td class="lang">
                            <?$Form->TextArea( 'descriptionI'.$formId.'s['.$items_keys[$i].']['.$lang_keys[$j].']', $items[$items_keys[$i]]['text'][$lang_keys[$j]], 2, 110 );?>
<!--                            <textarea cols="15" rows="2" name="descriptionI--><?//=$formId?><!--s[--><?//=$items_keys[$i]?><!--][--><?//=$lang_keys[$j]?><!--]">--><?//=$items[$items_keys[$i]]['text'][$lang_keys[$j]]?><!--</textarea>-->
                        </td>
                        <?
                    }
                    ?>

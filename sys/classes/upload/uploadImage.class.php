...
class UploadImage extends UploadClass {
    ...
    var $max_image_height = STORE_IMAGE_HEIGHT;
    var $max_image_width = STORE_IMAGE_WIDTH;
    var $add_text = ADDITIONAL_FILES_TEXT;
    var $quality = MAX_IMAGES_QUANTITY;
    // ================================================================================================
    ...
    function UploadImage($module, $position = NULL, $path, $table = TblModUploadImg, $table_spr = NULL, $max_items = NULL,$lang = NULL,$max_image_height= NULL,$max_image_width= NULL){
...
// ================================================================================================
// Function : GetFirstPictureInArrayExSize
// Version : 1.0.0
// Date : 05.07.2010
//
// Parms :   $id_pos     / position id
...
//           $path  / path to file
// Returns : $res / Void
// Description : Get Picture In Array Ex Size
// Programmer : Oleg Morgalyuk
// ================================================================================================
    ...
    /**
     * UploadImage::GetPictureInArrayExSizeAuto()
     * Get Picture In Array Ex Size Auto
     * @copyright Yaroslav Gyryn 24.04.2012
     * @param mixed $idPosition
     * @param mixed $lang
     * @param integer $limit
     * @param mixed $width
     * @param mixed $height
     ...
     * @return
     */
    function GetPictureInArrayExSizeAuto($idPosition,$lang,$limit=1,$width = NULL,$height=NULL,$hor_align=true,$ver_align=true, $quality = NULL, $wtm = NULL,$width2 = NULL, $height2= NULL ) {
        $model =  new UploadModel();
        $array = $model->GetImagesForPositionFront($idPosition,$this->module,$this->table,$this->table_spr,$this->path,$this->add_text,2,$limit,$lang,1,$width,$height,$hor_align,$ver_align,$quality,$wtm,$width2, $height2);
        return $array;
    }

...
//       echo '<br> $row_res[name]='.$row_res['name'];
   ...
   // Change Request Nbr:
   // ================================================================================================
   public function GetTranslitByCod($Table, $cod, $lang_id = _LANG_ID)
   {
       if ( empty($cod) ) return false;
       $tmp_db = DBs::getInstance();
       ...
       return $retval;
   }  //end of function GetTranslitByCod
...
//         echo '<br>q='.$q.' res='.$res.' $db->result='.$db->result;
   ...
   function GetStructureInArray( $spr, $level_start = 0, $lang_id = NULL, $default_val = NULL, $spacer = NULL, $show_shortname = 1, $show_name = 1, $show_sublevels = 1, $front_back = 'back', $mas=NULL )
   {
    ...
    return $mas;
     ...
     function GetStructureInArrayForNews( $spr, $level_start = 0, $lang_id = NULL, $default_val = NULL, $spacer = NULL, $show_shortname = 1, $show_name = 1, $show_sublevels = 1, $front_back = 'back', $mas=NULL )
     {
         $db = DBs::getInstance();
         if( empty($lang_id) ) $lang_id = $this->lang_id;
         if( $show_sublevels==0){
         ...
         return $mas;
     }// end of function GetStructureInArrayForNews()
...
//       echo '<br>$name='.$name;
       $name = addslashes(str_replace("\\", "/", stripslashes($name)));
//       echo '<br>$name='.$name;
       //die();

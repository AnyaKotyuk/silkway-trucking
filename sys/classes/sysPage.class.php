...
class Page {
    ...
    public $lang_id = NULL;
    public $is_404 = false;
    public $multiUrls = NULL;

    public $Lang = NULL;
    public $page_encode = NULL;
    ...
    {
     if( $this->Is_404() ) {
         $Spr = new SystemSpr($this->lang_id);
         $txt = $Spr->GetNameByCod(TblBackMulti, 'MSG_404_PAGE_NOT_FOUND', $this->lang_id, 1);
     ...
     * @return
     */
    function setMultiUrls( $multiUrls='' )
    {

...
include_once( SITE_PATH.'/admin/include/defines.inc.php' );
        // General options
        session_start();
        $lang=strtolower($_SESSION['_LANG_SHORT']);
        if($lang=="ua") $lang="uk";
        ...
        $mcFileManagerConfig['general.language'] = $lang; // en, sv
        ...
        $mcFileManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT']; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/uploads/contentfiles/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv,doc,docx,xls,xlsx,ppt,pptx,zip,rar,pdf,txt";
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,xls,xlsx,exel,exelx,ppt,pptx,zip,rar,pdf,txt";
        ...
        $mcFileManagerConfig['download.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,xls,xlsx,exel,exelx,ppt,pptx,zip,rar,pdf,txt";

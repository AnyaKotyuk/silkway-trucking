<?php
        ...
        $mcImageManagerConfig['general.language'] = $lang; // en, sv
        ...
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/uploads/contentfiles/'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,exel,exelx,ppt,pptx,zip,rar,pdf";
        ...
        $mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,exel,exelx,ppt,pptx,zip,rar,pdf";
        ...
        $mcImageManagerConfig['download.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,exel,exelx,ppt,pptx,zip,rar,pdf";
        // Edit image options

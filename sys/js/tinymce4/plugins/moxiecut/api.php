...
$max_uploaded_size = MAX_IMAGE_SIZE;
error_reporting(7);
...
$uploaddir = "";
$globaldirs = array("uploads/contentfiles/images"=>array("ext"=>"jpg,gif,png,bmp"),
                    "uploads/contentfiles/documents"=>array("ext"=>"doc,xls,pdf,ppt,txt,csv"),
                    "uploads/contentfiles/media"=>array("ext"=>"mp3,wmv,avi,mp4,mov,flv,mkv,mpg"),
                    "uploads/contentfiles/other"=>array("ext"=>"dat,exe,zip,rar,iso"),
                    "uploads/contentfiles/downloaded"=>array("ext"=>""),
              );
//$globaldirs = array(""=>array("ext"=>"jpg,gif,png,bmp,doc,xls,pdf,ppt,txt,csv,mp3,wmv,avi,mp4,mov,flv,mkv,mpg,dat,exe,zip,rar,iso"));
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if($method == "FileInfo")
    {
        ...
        if($PARAMS["insert"])
        {
            ...
            $preview = ($type == "jpg" ? "p" : "-");
            $attr = "-rwr-v".$preview;
            /*?><script>console.log('$file=<?=$file?>');</script><?*/
    ...
    if($method == "delete")  // �������� ������
    {
        ...
        foreach($PARAMS["paths"] as $file)
        {
            ...
            /*?><script>console.log('$patharr[0]=<?=$patharr[0]?> $patharr[1]=<?=$patharr[1]?>');</script><?*/

...
// ================================================================================================
include_once( $_SERVER['DOCUMENT_ROOT'].'/admin/include/defines.inc.php' );
...
switch ($task){
    case 'export_to_xml': case 'export_price': case 'export_to_csv': case 'export_to_txt': case 'backup':
            set_time_limit (0);
